...
def test_caso_normal_6():
    ...
    usuario: Usuario = Usuario("Juan", "cedula", "123323", "mdsse", "juann_123@gmail.com", "11/09/2000")
    app.iniciar_sesion("Juan", "mdsse")
    transaccion: Transacciones = Transacciones(100000, "pago", "05/03/2025", "1:00")
    usuario.realizar_transaccion(transaccion)
    nueva_transaccion: Transacciones = Transacciones(-5000, "comida", "07/03/2025", "12:30")
    usuario.actualizar_transaccion(nueva_transaccion)
...
def test_caso_normal_9():
    ...
    transaccion2: Transacciones = Transacciones(-5000, "transporte", "21/02/2025", "12:00")
    usuario.realizar_transaccion(transaccion2)
    transaccion3: Transacciones = Transacciones(1500000, "salario", "30/01/2025", "10:00")
    usuario.realizar_transaccion(transaccion3)
    transaccion4: Transacciones = Transacciones(50000, "ropa", "26/02/2025", "3:00")
    usuario.realizar_transaccion(transaccion4)
    transacciones_filtradas = usuario.visualizar_transacciones("10/02/2025", "28/02/2025")
    assert transacciones_filtradas == [transaccion1, transaccion2, transaccion3, transaccion4]
...
def test_caso_normal_11():
    ...
    resultado = app.iniciar_sesion(usuario,"Hola")
    if resultado  == None:
        assert False
    assert True
...
def test_caso_normal_16():
    app: Aplicacion = Aplicacion()
    usuario: Usuario = Usuario("Bon", "cedula", 3788933, "pl0000", "bonn_0101@gmail.com", "11/09/2000")
    app.iniciar_sesion(usuario, "pl0000")
    nueva_contraseña = "1234aaa"
...
def test_caso_normal_17():
    app: Aplicacion = Aplicacion()
    usuario: Usuario = Usuario("Lupe", "cedula", 788931, "pl0000", "luppe_11@gmail.com", "11/09/2000")
    app.iniciar_sesion(usuario, "pl0000")
    nueva_contraseña = "ADE32p1"
    resultado = app.cambiar_contrasena(nueva_contraseña)
    if resultado == None:
        assert False
    assert True
...
def test_caso_normal_18():
    app: Aplicacion = Aplicacion()
    usuario: Usuario = Usuario("Luz", "cedula", 708931, "pl0000", "luuzp123@gmail.com", "11/09/2000")
    app.iniciar_sesion(usuario, "pl0000")
    nueva_contraseña = "Poll1."
    resultado = app.cambiar_contrasena(nueva_contraseña)
    if resultado == None:
        assert False
    assert True
